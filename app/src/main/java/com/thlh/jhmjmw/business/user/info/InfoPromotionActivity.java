 ...
 * 物流消息页
 */
public class InfoPromotionActivity extends BaseViewActivity {
    ...
    public static void activityStart(Context context) {
        ...
        intent.setClass(context, InfoPromotionActivity.class);
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        infoHeader.setTitle(getResources().getString(R.string.activity));
        ...
        infoAdapter.setOnItemClickListener(new EasyRecyclerViewHolder.OnItemClickListener() {
            ...
            public void onItemClick(View convertView, int position) {
                OrderTraceActivity.activityStart(InfoPromotionActivity.this, ((LogsOrder) infoAdapter.getItem(position)).getOrder_id());
            }
        });
...
//        loadCollectData();
    ...
    private void loadCollectData(){
        subscription = NetworkManager.getMessageApi()
                .orderInfo(SPUtils.getToken(),current_page,Constants.PageDataCount,"1")
