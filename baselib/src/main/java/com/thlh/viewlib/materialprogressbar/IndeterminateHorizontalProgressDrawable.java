...
package com.thlh.viewlib.materialprogressbar;
...
import com.thlh.viewlib.materialprogressbar.internal.ThemeUtils;
...
public class IndeterminateHorizontalProgressDrawable extends IndeterminateProgressDrawableBase implements ShowTrackDrawable {
    ...
    private static final float PROGRESS_INTRINSIC_HEIGHT_DP = 0;//3.2f
    private static final float PADDED_INTRINSIC_HEIGHT_DP = 0;//16
    private static final RectF RECT_BOUND = new RectF(-180, -2, 180, 0);
    private static final RectF RECT_PADDED_BOUND = new RectF(-180, -2, 180, 0);
    private static final RectF RECT_PROGRESS = new RectF(-144, -2, 144, 0);
