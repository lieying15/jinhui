...
import com.thlh.viewlib.materialprogressbar.internal.DrawableCompat;
...
public class MaterialProgressBar extends ProgressBar {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mProgressStyle = a.getInt(R.styleable.MaterialProgressBar_mpb_progressStyle, PROGRESS_STYLE_HORIZONTAL);
