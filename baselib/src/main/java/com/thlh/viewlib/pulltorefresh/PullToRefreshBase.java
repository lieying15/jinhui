...
import com.thlh.viewlib.pulltorefresh.internal.FlipLoadingLayout;
import com.thlh.viewlib.pulltorefresh.internal.RotateLoadingLayout;
import com.thlh.viewlib.pulltorefresh.internal.Utils;
import com.thlh.viewlib.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public static enum Mode {
		...
		public boolean showFooterLoadingLayout() {
			return this == PULL_FROM_END || this == BOTH || this == MANUAL_REFRESH_ONLY ||this == PULL_FROM_START;
		}
