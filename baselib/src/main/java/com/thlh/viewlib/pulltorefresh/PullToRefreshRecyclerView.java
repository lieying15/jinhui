...
public class PullToRefreshRecyclerView extends PullToRefreshBase<EasyRecyclerView> {
    ...
    @Override
    protected EasyRecyclerView createRefreshableView(Context context, AttributeSet attrs) {
        EasyRecyclerView recyclerView = (EasyRecyclerView) LayoutInflater.from(context).inflate(R.layout.view_recycler_vertiacl_scrollbar, null);
