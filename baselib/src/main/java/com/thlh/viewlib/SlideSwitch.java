...
public class SlideSwitch extends View {
	...
	private static final int DEFAULT_COLOR_THEME = Color.parseColor("#ffffffff");
	private  static final int DEFAULT_BUTTON_CLOSE_COLOR = Color.GRAY; //
	private  static final int DEFAULT_BUTTON_OPEN_COLOR = Color.parseColor("#ff2a4098"); //
	// 3 attributes
	...
	protected void onDraw(Canvas canvas) {
		if (shape == SHAPE_RECT) {
			paint.setColor(DEFAULT_BUTTON_CLOSE_COLOR);
...
//			paint.setColor(DEFAULT_BUTTON_COLOR);
//			canvas.drawRoundRect(frontCircleRect, radius, radius, paint);
			...
			paint.setColor(DEFAULT_BUTTON_CLOSE_COLOR);
			canvas.drawRoundRect(frontCircleRect, radius, radius, paint);
			paint.setColor(DEFAULT_BUTTON_OPEN_COLOR);
			paint.setAlpha(alpha);
			canvas.drawRoundRect(frontCircleRect, radius, radius, paint);
