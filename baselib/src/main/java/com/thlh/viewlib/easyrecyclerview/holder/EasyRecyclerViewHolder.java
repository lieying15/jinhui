...
package com.thlh.viewlib.easyrecyclerview.holder;
...
public class EasyRecyclerViewHolder extends RecyclerView.ViewHolder {
    ...
    public static EasyRecyclerViewHolder createViewHolder(View itemView)
    {
        EasyRecyclerViewHolder holder = new EasyRecyclerViewHolder(itemView);
        return holder;
    }

    public static EasyRecyclerViewHolder createViewHolder(Context context,ViewGroup parent, int layoutId)
    {
