...
package com.thlh.viewlib.convenientbanner;
 ...
 * The adapter must be prepared to createAndShow 2 extra items e.g.:
 * <p/>
 * The original adapter creates 4 items: [0,1,2,3]
 * The modified adapter will have to createAndShow 6 items [0,1,2,3,4,5]
