package com.thlh.viewlib.convenientbanner.salvage;
...
public abstract class RecyclingPagerAdapter extends PagerAdapter {
   ...
   * createAndShow a View manually or inflate it from an XML layout file. When the View is inflated, the
   ...
   *        this view to display the correct data, this method can createAndShow a new view.
