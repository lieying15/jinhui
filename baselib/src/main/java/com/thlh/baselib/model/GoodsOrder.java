...
//    private String  num;//订单跟踪中的商品数量
    ...
    public int getIs_fridge(){
        return is_fridge;
    }

    public void setIs_fridge(int is_fridge){
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.is_div_delivery);
        dest.writeString(this.is_mjb);
        dest.writeString(this.supplier_name);
        dest.writeString(this.supplier_tel);
        dest.writeInt(this.storage);
        dest.writeString(this.supplier_price);
        dest.writeString(this.special);
        dest.writeString(this.bundling_price);
        dest.writeString(this.item_no);
        dest.writeString(this.item_num);
        dest.writeString(this.is_part);
        dest.writeString(this.part_of_id);
        dest.writeString(this.part_is_bundling);
        dest.writeString(this.is_prepare);
        dest.writeString(this.is_limit);
        dest.writeString(this.is_pack);
        dest.writeString(this.pack_num);
        dest.writeString(this.limit_icon);
        dest.writeString(this.limit_num);
        dest.writeString(this.mjb_value);
        dest.writeParcelable(this.supplier, flags);
        //
        dest.writeInt(this.is_fridge);
    }
    ...
    protected GoodsOrder(Parcel in) {
        ...
        this.is_div_delivery = in.readString();
        this.is_mjb = in.readString();
        this.supplier_name = in.readString();
        this.supplier_tel = in.readString();
        this.storage = in.readInt();
        this.supplier_price = in.readString();
        this.special = in.readString();
        this.bundling_price = in.readString();
        this.item_no = in.readString();
        this.item_num = in.readString();
        this.is_part = in.readString();
        this.part_of_id = in.readString();
        this.part_is_bundling = in.readString();
        this.is_prepare = in.readString();
        this.is_limit = in.readString();
        this.is_pack = in.readString();
        this.pack_num = in.readString();
        this.limit_icon = in.readString();
        this.limit_num = in.readString();
        this.mjb_value = in.readString();
        this.supplier = in.readParcelable(Supplier.class.getClassLoader());
        //
        this.is_fridge=in.readInt();
    }

    public static final Parcelable.Creator<GoodsOrder> CREATOR = new Parcelable.Creator<GoodsOrder>() {
        @Override
